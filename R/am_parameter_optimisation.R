...
JDO_jul_ndc <- nc_open(paste("data/ACURE_P3_AOD_Total_jul.nc"))
JDO_jul <- ncvar_get(JDO_jul_ndc, names(JDO_jul_ndc$var))
...
source("R/JJCode_DSEmFit_Function.r")
EmulatorModel<-JJCode_FitDSEm_EmModel(TrInputs = x_norm_T_matrix,
                                      TrOutput = AODs_Total_jul_level2_gb,
                                      InputNames = names(JDO_jul_ndc$var)
                                      )
