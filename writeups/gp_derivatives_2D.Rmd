---
title: "GPs and their derivatives"
output:
  pdf_document:
...
Two things are attempted below, each presented in their own section:
...
# Fitting a \textcolor{red}{two-dimensional} GP in `R`
...
The following is taken from @keirstead12, a demo of Gaussian process regression with R by James Keirstead (5 April 2012). He writes:
